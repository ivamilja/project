...
export class DeliveryOrderItemService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/delivery-order-items';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IDeliveryOrderItem[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
