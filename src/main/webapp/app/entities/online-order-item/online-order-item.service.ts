...
export class OnlineOrderItemService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/online-order-items';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IOnlineOrderItem[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
