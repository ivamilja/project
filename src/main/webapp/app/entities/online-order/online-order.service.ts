...
export class OnlineOrderService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/online-orders';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IOnlineOrder[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
