...
public class ArticleResourceIntTest {
    ...
    private static final Integer DEFAULT_AVAILABLE_AMOUNT = 0;
    private static final Integer UPDATED_AVAILABLE_AMOUNT = 1;
    ...
    public static Article createEntity(EntityManager em) {
        ...
        article.setArticleNumber(DEFAULT_ARTICLE_NUMBER);
        article.setPrice(DEFAULT_PRICE);
        article.setAvailableAmount(DEFAULT_AVAILABLE_AMOUNT);
        return article;
    }
    ...
    public void updateArticle() throws Exception {
        ...
        updatedArticle.setName(UPDATED_NAME);
        updatedArticle.setArticleNumber(UPDATED_ARTICLE_NUMBER);
        updatedArticle.setPrice(UPDATED_PRICE);
        updatedArticle.setAvailableAmount(UPDATED_AVAILABLE_AMOUNT);
