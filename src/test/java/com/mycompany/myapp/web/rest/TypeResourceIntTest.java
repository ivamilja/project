...
public class TypeResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.TypeSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final TypeResource typeResource = new TypeResource(typeRepository, mockTypeSearchRepository);
